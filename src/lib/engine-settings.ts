...
export interface EngineSettings {
  ...
  aiProvider: "auto" | "gemini" | "openrouter" | "groq" | "mistral"; // hard-pin choice; "auto" = fallback chain

  // ---- Player Development ----
  trainingDpThreshold: number; // DP threshold for a 0.1 point upgrade
}
